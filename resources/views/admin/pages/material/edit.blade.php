                    ...
                    <div class="md:col-span-2 rounded-xl border border-gray-200 bg-white p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <label class="flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                                <input type="checkbox" name="is_displayed" value="1" {{ old('is_displayed', $material->is_displayed ?? true) ? 'checked' : '' }} class="mt-1 rounded border-gray-300 text-primary focus:ring-primary">
                                <span>
                            ...
                            <label class="flex items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                                <input type="checkbox" id="is_for_sale" name="is_for_sale" value="1" {{ old('is_for_sale', $material->is_for_sale) ? 'checked' : '' }} class="mt-1 rounded border-gray-300 text-primary focus:ring-primary">
                                <span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div id="price-wrapper">
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price', $material->price ?? 0) }}" min="0" step="1" class="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="0">
                            </div>
                        </div>
                        <div id="conditional-requirement-wrapper" class="mt-4 {{ $selectedTypePrice === 'free_conditional' ? '' : 'hidden' }}">
                            ...
                            <textarea id="conditional_requirement" name="conditional_requirement" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Syarat akses gratis bersyarat">{{ old('conditional_requirement', $material->conditional_requirement ?? '') }}</textarea>
                        </div>
                        <div id="access-duration-wrapper" class="mt-4 {{ old('is_for_sale', $material->is_for_sale) ? '' : 'hidden' }}">
...
<script>
    ...
    const selectedMaterialCategoryId = Number(@json((int) ($selectedCategoryId ?? 0)));
    ...
    if (goalCategorySelect && materialCategorySelect) {
        if (selectedGoalCategoryId) {
            goalCategorySelect.value = selectedGoalCategoryId;
            renderMaterialCategoryOptions(selectedGoalCategoryId, selectedMaterialCategoryId);
        }
