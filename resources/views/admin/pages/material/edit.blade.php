                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="flex items-center mb-1">
                            <input type="checkbox" id="is_for_sale" name="is_for_sale" value="1" {{ old('is_for_sale', $material->is_for_sale) ? 'checked' : '' }} class="rounded border-gray-300 text-primary focus:ring-primary">
                    ...
                    <div>
                        <label class="flex items-center mb-1">
                            <input type="checkbox" name="is_displayed" value="1" {{ old('is_displayed', $material->is_displayed ?? true) ? 'checked' : '' }} class="rounded border-gray-300 text-primary focus:ring-primary">
