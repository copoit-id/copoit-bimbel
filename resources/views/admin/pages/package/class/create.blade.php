...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-500">Buat kelas baru untuk paket {{ $package->name }}</p>
        </div>
        <a href="{{ route('admin.package.class.index', $package->package_id) }}"
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.package.class.store', $package->package_id) }}" method="POST">
            @csrf
