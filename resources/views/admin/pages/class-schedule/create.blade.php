...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.class-schedules.store') }}" class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <!-- Hidden inputs for fixed weekly schedule values -->
        <input type="hidden" name="schedule_type" value="recurring">
        ...
        <div class="grid gap-5 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                @php
                    $selectedDestinationIds = collect(old('destination_category_ids', []))
                        ->map(fn($id) => (int) $id)
                        ->all();
                @endphp
                                    ...
                                    >
                                        <td class="px-4 py-3 align-top">
                                            <input
                                                ...
                                                @checked(in_array($category->id, $selectedDestinationIds, true))
                                            >
                                        </td>
                                        <td class="px-4 py-3">
