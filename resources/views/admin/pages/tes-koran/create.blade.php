                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select id="package_id" name="package_id" required
                            ...
                            <option value="{{ $pkg->package_id }}" {{ old('package_id', request('package_id')) == $pkg->package_id ? 'selected' : '' }}>
                                {{ $pkg->name }}
                            </option>
                            @endforeach
                        </select>
                        <p class="text-xs text-gray-500 mt-1">
                            <a href="{{ route('admin.tes-koran.create-package') }}" class="text-primary hover:underline">
                                + Buat paket baru
                            </a>
                        </p>
                    </div>
