...
@section('title', 'Tambah Tentor')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Tentor</h1>
            <p class="text-sm text-gray-500">Lengkapi data tentor yang akan diassign ke kelas atau jadwal.</p>
        </div>
