...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Edit Rombel</h2>
            <p class="text-gray-500">Perbarui data rombel {{ $studyGroup->name }}.</p>
        </div>
    ...
    @include('admin.pages.study-group.form', [
        'action' => route('admin.study-groups.update', $studyGroup),
        'method' => 'PUT',
        'buttonLabel' => 'Update Rombel',
    ])
</div>
@endsection
