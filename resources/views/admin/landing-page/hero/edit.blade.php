...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form action="{{ route('admin.landing-page.hero.update', $hero) }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $hero->title) }}" 
                ...
                <div>
                    ...
                    <textarea id="subtitle" name="subtitle" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent @error('subtitle') border-red-500 @enderror">{{ old('subtitle', $hero->subtitle) }}</textarea>
                    @error('subtitle')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $hero->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="stat_1_number" name="stat_1_number" value="{{ old('stat_1_number', $hero->stat_1_number) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="stat_1_text" name="stat_1_text" value="{{ old('stat_1_text', $hero->stat_1_text) }}" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <input type="text" id="stat_2_number" name="stat_2_number" value="{{ old('stat_2_number', $hero->stat_2_number) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="stat_2_text" name="stat_2_text" value="{{ old('stat_2_text', $hero->stat_2_text) }}" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        <div>
                            ...
                            <input type="text" id="stat_3_number" name="stat_3_number" value="{{ old('stat_3_number', $hero->stat_3_number) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" id="stat_3_text" name="stat_3_text" value="{{ old('stat_3_text', $hero->stat_3_text) }}" 
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" id="button_text" name="button_text" value="{{ old('button_text', $hero->button_text) }}" 
                ...
                <div>
                    ...
                    <input type="url" id="button_link" name="button_link" value="{{ old('button_link', $hero->button_link) }}" 
