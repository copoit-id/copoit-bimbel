...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900">Tambah Gallery</h1>
</div>

<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    <form action="{{ route('admin.landing-page.gallery.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
        @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    @error('image')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-sm mt-1">Format: JPG, PNG, GIF. Max: 2MB. Rasio yang direkomendasikan: 16:9</p>
                </div>
