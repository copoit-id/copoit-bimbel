        ...
        <section class="space-y-4">
            ...
            @forelse($todaySessions as $session)
                <article class="rounded-2xl border border-gray-200 bg-white p-5 sm:p-6">
                    ...
                    <div class="mt-5 flex flex-wrap gap-2 border-t border-gray-100 pt-4"><a href="{{ route('tutor.attendance.show', $session) }}#absensi-saya" class="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-primary/90"><i class="ri-user-check-line"></i>Absensi Saya</a><a href="{{ route('tutor.attendance.show', $session) }}#absensi-peserta" class="inline-flex items-center gap-2 rounded-lg border border-primary px-4 py-2.5 text-sm font-semibold text-primary hover:bg-primary hover:text-white"><i class="ri-team-line"></i>Absensi Peserta</a><a href="{{ route('tutor.schedule.progress.create', $session) }}" class="inline-flex items-center gap-2 rounded-lg border border-primary px-4 py-2.5 text-sm font-semibold text-primary hover:bg-primary hover:text-white"><i class="ri-line-chart-line"></i>{{ $session->progress_reports_count ? 'Kelola '.$session->progress_reports_count.' laporan' : 'Laporan perkembangan' }}</a></div>
                </article>
            @empty
