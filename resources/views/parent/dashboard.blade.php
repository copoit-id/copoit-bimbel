...
@else
    <div class="space-y-5">
        <header class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            ...
            <a href="{{ route('parent.report') }}" class="inline-flex w-fit items-center gap-2 rounded-lg border border-primary px-4 py-2.5 text-sm font-semibold text-primary transition-colors hover:bg-primary/5"><i class="ri-file-chart-line"></i>Laporan belajar</a>
        </header>
