...
<div class="space-y-6">
    @php
        ...
        $subscriptionTokenPercentage = $subscriptionTokenLimit > 0
            ...
            : null;
        $subscriptionChatsUsed = (int) data_get($subscription, 'chats_used', 0);
        $subscriptionExhausted = data_get($subscription, 'status') === 'active'
