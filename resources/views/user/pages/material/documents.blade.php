...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        <nav class="flex items-center text-sm text-gray-500">
            ...
            <span class="text-gray-900">Dokumen Belajar</span>
        </nav>
    </div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Dokumen Belajar</h1>
            <p class="text-gray-600 mt-1">Baca dan pelajari modul serta dokumen pembelajaran</p>
        </div>
    </div>
            ...
            <div class="p-6">
                ...
                <div class="mt-4 pt-4 border-t flex items-center justify-between">
                    ...
                    <span class="text-primary group-hover:translate-x-1 transition-transform">
                        Baca <i class="ri-arrow-right-line"></i>
                    </span>
                </div>
            </div>
        </a>
    ...
    <div class="text-center py-16 bg-white rounded-lg shadow">
        ...
        <p class="text-gray-500">Anda belum memiliki akses ke dokumen pembelajaran.</p>
    </div>
    @endif
</div>
@endsection
