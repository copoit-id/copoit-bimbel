                ...
                <div>
                    ...
                    <div class="flex flex-col justify-center items-center">
                        ...
                        @if (isset($rawScore) && isset($maxScore))
                            ...
                            <p
                                class="text-md px-4 py-1 {{ $isOverallPassed ? 'bg-green' : 'bg-red' }} text-white rounded-md">
            ...
            @if (isset($subtestResults) && count($subtestResults) >= 1)
                <div class="bg-white rounded-lg border border-border p-6 mb-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    $result['total_questions'] }} benar</p> --}}
                                            <div class="text-dark flex items-center gap-2">
                                                <p class="font-bold">
                                                    {{ $result['raw_score'] }}/{{ $result['max_score'] }}</p>
                                                <p>-</p>
                    ...
                    <div
                        ...
                        @endphp
                        <p
                            class="text-sm {{ collect($subtestResults)->every('is_passed') ? 'text-green-700' : 'text-red' }}">
