...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $permissionIds = DB::table('permissions')->where('feature', $feature)->pluck('id');
    ...
    {
        $permissionIds = DB::table('permissions')->where('feature', 'general_page')->pluck('id');
