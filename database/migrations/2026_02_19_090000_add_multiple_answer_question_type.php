...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE question_bank_questions MODIFY question_type ENUM('multiple_choice','essay','true_false','short_answer','matching','audio') NOT NULL DEFAULT 'multiple_choice'");
    }
};
