...
Route::get('/ai-learning-tools', [GeneralPageController::class, 'aiLearningTools'])->name('ai-learning-tools');
...
Route::prefix('{portal}')
    ...
    ->group(function () {
        ...
        Route::prefix('soal')->name('question.')->group(function () {
            ...
            Route::post('/{tryoutDetail}/ai-generator/preview', [TryoutAiQuestionGeneratorController::class, 'preview'])->name('ai-generator.preview');
            Route::post('/{tryoutDetail}/ai-generator/store', [TryoutAiQuestionGeneratorController::class, 'store'])->name('ai-generator.store');
            Route::post('/{tryoutDetail}/ai-generator/reset', [TryoutAiQuestionGeneratorController::class, 'reset'])->name('ai-generator.reset');
            Route::post('/{tryout_detail_id}/{question_id}/duplicate', [QuestionController::class, 'duplicate'])->name('duplicate');
