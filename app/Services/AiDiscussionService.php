...
PROMPT;
    ...
    {
        return match ($feature) {
            'learning_note' => 'Buat catatan materi LENGKAP berdasarkan materi atau soal yang diberikan, bukan ringkasan singkat. Summary harus berisi 6–10 paragraf yang menjelaskan konsep, alur pemahaman, dan miskonsepsi umum bila relevan. Isi minimal delapan key_points. Respons WAJIB hanya berupa satu object JSON valid tanpa Markdown atau teks tambahan dengan schema {"title":"string","summary":"string","key_points":["string"],"formulas":["string"]}.',
