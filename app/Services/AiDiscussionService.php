...
PROMPT;
    ...
    private function structuredFeatureInstruction(string $feature): ?string
    {
        return match ($feature) {
            ...
            'learning_recommendation' => 'Buat rekomendasi belajar berdasarkan konsep pada materi atau soal yang diberikan. WAJIB sertakan dua sampai tiga rekomendasi video belajar sebagai judul dan kata kunci pencarian yang spesifik; jangan membuat URL atau nama channel. Respons WAJIB hanya berupa satu object JSON valid tanpa Markdown atau teks tambahan dengan schema {"title":"string","focus_topics":[{"topic":"string","reason":"string","priority":"tinggi|sedang|rendah"}],"study_plan":["string"],"video_recommendations":[{"title":"string","search_query":"string","reason":"string"}]}.',
