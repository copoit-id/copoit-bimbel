...
class TryoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type_tryout' => 'required|in:TIU,TWK,TKP,SKD_FULL,TBA,TBI,UTBK_FULL,UTBK_SECTION,UTBK_PENALARAN_UMUM,UTBK_PENGETAHUAN_UMUM,UTBK_PENGETAHUAN_KUANTITATIF,UTBK_PEMAHAMAN_BACAAN_MENULIS,UTBK_LITERASI_BAHASA_INDONESIA,UTBK_LITERASI_BAHASA_INGGRIS,UTBK_PENALARAN_MATEMATIKA',
